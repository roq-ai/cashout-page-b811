...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Cashout page`}</title>

        <meta
          name="description"
          content="Experience streamlined transactions with Cashout Page, your go-to platform for account creation, offer viewing, screenshot uploading, report analysis, and seamless cashouts."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhY2NvdW50JTIwY3JlYXRpb258ZW58MHx8fHwxNjkyOTkyNzY3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience streamlined transactions with Cashout Page, your go-to platform for account creation, offer viewing, screenshot uploading, report analysis, and seamless cashouts.`}
            </Text>
            <Box
